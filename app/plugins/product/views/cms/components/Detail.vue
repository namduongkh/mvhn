        ...
        <div class="row">
          <div class="col-sm-9">
            ...
            <div class="row">
              <div class="col-sm-4">
                <fieldset class="form-group">
                  <label class="form-label semibold" for="rootPrice"
                    >Root price</label
                  >
                  <input
                  ...
                  />
                  <small v-show="errors.has('rootPrice')" class="text-danger">{{
                    errors.first("rootPrice")
                  }}</small>
                </fieldset>
              </div>
              ...
              <div class="col-sm-4">
                <fieldset class="form-group">
                  ...
                  />
                  <small v-show="errors.has('price')" class="text-danger">{{
                    errors.first("price")
                  }}</small>
                </fieldset>
              </div>
              ...
              <div class="col-sm-4">
                <fieldset class="form-group">
                  <label class="form-label semibold" for="quantity"
                    >Quantity</label
                  >
                  <input
                    ...
                    min="0"
                  />
                  <small v-show="errors.has('quantity')" class="text-danger">{{
          ...
          <div class="col-sm-3">
            <div class="row">
              ...
              <div class="col-12">
                <fieldset class="form-group">
                  <label class="form-label semibold" for="galleries"
                    >Galleries</label
                  >
                  <imageUploader
                    name="galleries"
                    ...
                    :multiple="true"
                  />
                  <small v-show="errors.has('galleries')" class="text-danger">{{
                    errors.first("galleries")
                  }}</small>
                </fieldset>
              </div>
            </div>
