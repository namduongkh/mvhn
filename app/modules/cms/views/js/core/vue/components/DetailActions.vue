    ...
    <header class="section-header">
        <div class="row">
            ...
            <div class="col-sm-8 text-right">
                ...
                <button :disable="disable" @click="saveData({gotoList: true, listRouter: listRouter})" class="btn btn-primary">Lưu & Thoát</button>
                <button :disable="disable" @click="saveData({ routeDetail: routeDetail })" class="btn btn-success">Lưu</button>
