<template>
    <div class="dropdown dropdown-notification messages" id="toast-notify">
        <a href="#"
           class="header-alarm " :class="{active: notifyData.length }"
           id="dd-messages"
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="tab-incoming" role="tabpanel">
                    <div class="dropdown-menu-messages-list">
                        <a onclick="null" @click="index_opening = index" v-for="(noti, index) in notifyData" class="mess-item">
                            ...
                            <span class="mess-item-txt" :class="{'show-detail': index === index_opening }" v-if="noti && noti.length >= 1" v-html="noti[0].message"></span>
                        </a>
                    </div>
                </div>
            </div>
