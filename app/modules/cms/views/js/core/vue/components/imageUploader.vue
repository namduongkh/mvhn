    ...
    <div class="image-uploader" :class="wrapClass">
        ...
        <div v-if="multiple" v-for="(img, index) in listImg" class="img-preview">
            ...
            <div class="actions">
                ...
                <button type="button" v-if="cropButton" @click="crop(img, index)" class="btn btn-warning">Crop</button>
            </div>
        </div>

        <div v-show="uploading" class="img-preview">
            <img src="/assets/images/loading.svg" class="img img-responsive" :class="classImg" alt="Img src">
        </div>

        <input :id="id" :name="name" :multiple="false" class="hidden" type="file" ref="fileUpload" @change="upload">
        <button v-show="!uploading" type="button" v-if="!imgSrc || multiple" class="btn btn-upload" :class="classButtonUpload" @click="uploadImg">{{ placeholder }}</button>

        <CropImage v-if="cropButton" @save="saveImgCrop"
                   :image="img_src_crop"
                   :showCrop="showCrop"
