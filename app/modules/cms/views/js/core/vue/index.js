...
if(document.getElementById('app')){
    console.info(`%cBizzon%cCMS%cv2%c`,"background: #77bb41; padding: 4px; color: #fff","background: red ; padding: 4px; color: #fff","background: #fdad2b ; padding: 4px; color: #fff", "background: tranperent;");
    new Vue({
        el: '#app',
        router,
        store,
