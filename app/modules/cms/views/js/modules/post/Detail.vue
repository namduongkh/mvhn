                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <fieldset class="form-group">
                            ...
                            <input v-model="formData.teaser"  type="text" class="form-control" id="teaser" placeholder="Teaser" >
                        </fieldset>
                        <fieldset class="form-group">
                            <label class="form-label semibold" for="category">Category</label>
                            <select2 id="category" v-validate="'required'" data-vv-name="Category"  name="category"
                                     v-model="formData.category" :ajax="ajaxCategory" placeholder="Chọn..."/>
                            <small v-show="errors.has('Category')" class="text-danger">{{ errors.first('Category') }}</small>
                        </fieldset>
                    </div>
                    <div class="col-sm-6">
                        <fieldset class="form-group">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <fieldset class="form-group">
                            ...
                            <froala :config="froalaConfig" :tag="'textarea'" v-model="formData.content"/>
...
export default {
  ...
  data() {
    return {
      ...
      apiUrl: `${window.settings.services.adminUrl}/post`,
      listCategory: [],
      ajaxCategory: {
        url: `${window.settings.services.adminUrl}/category/ajax?type=post`,
        dataType: "json",
